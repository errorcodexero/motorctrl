...
//
public class MotorCtrlAutoController extends AutoController {
    private AutoMode test_mode_ ;
    private AutoMode [] modes_ ;

    public MotorCtrlAutoController(MotorCtrl robot) throws MissingParameterException, BadParameterTypeException {
        super(robot, "MotorCtrlAutoController");

        MessageLogger logger = getRobot().getMessageLogger() ;
        modes_ = new AutoMode[10] ;
        
        try {
            test_mode_ = new MotorCtrlTestModeAuto(this);
            ...
            logger.add("cannot create automodes 'MotorCtrlAutomode', exception caught - ") ;
